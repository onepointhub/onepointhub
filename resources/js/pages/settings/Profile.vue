      ...
      <div class="flex flex-col space-y-6">
        ...
        >
          ...
          <div class="grid gap-2">
            ...
            <Select id="timezone" :default-value="user.timezone" name="timezone" required>
          ...
          <div v-if="mustVerifyEmail && !user.email_verified_at">
            <p class="-mt-4 text-sm text-muted-foreground">
              ...
              <Link
                :href="send()"
                as="button"
                class="text-foreground underline decoration-neutral-300 underline-offset-4 transition-colors
                  duration-300 ease-out hover:decoration-current! dark:decoration-neutral-500"
              >
